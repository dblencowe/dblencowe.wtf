...
```shell
git clone https://github.com/dblencowe/dblencowe.wtf
```
...
5) Build a local version of your site by executing `hugo server`. You can see the site by navigating to `http://localhost:1313/dblencowe.wtf/` (actual URL will be outputted in the CLI) in a browser.
...
`hugo.yaml`:
```yaml
baseURL: 'https://dblencowe.github.io/dblencowe.wtf'
title: 'Qubt Theme'
```
...
links:
  - github: https://github.com/dblencowe/dblencowe.wtf
  - link: https://github.com/dblencowe/dblencowe.wtf#readme
...
`https://dblencowe.github.io/dblencowe.wtf`